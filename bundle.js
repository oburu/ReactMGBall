	...
	var App = function (_Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function getDataFromURL() {
	      ...
	      var MGB_URL = 'https://mighty-gumball-api.herokuapp.com/mighty_gumball_api';
	      fetch(MGB_URL).then(function (response) {
	        return response.json();
	      }).then(function (sale) {
	        console.log(sale);
	        _this2.setState({
	          sales: [].concat(_toConsumableArray(_this2.state.sales), [sale])
	        });
	      });
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_sales_list2.default, { sales: this.state.sales })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SalesList = function SalesList(props) {
	  var videoItems = props.sales.map(function (shop, i) {
	    return _react2.default.createElement(
	      "li",
	      { key: i, className: "list-group-item justify-content-between" },
	      shop.name,
	      " ",
	      _react2.default.createElement(
	        "span",
